...
- required languages scripts need to be loaded before loading main language script ([#1387](https://github.com/peterpeterparker/highlight-code/pull/1387))
...
- added the ability to toggle the Carbon toolbar and adjust the margin ([#873](https://github.com/peterpeterparker/highlight-code/pull/873))
...
- load required scripts for prismjs ([#848](https://github.com/peterpeterparker/highlight-code/issues/848))
...
- make code white-space a css variable ([#707](https://github.com/peterpeterparker/highlight-code/issues/707))
...
- new optional terminal style "Ubuntu" ([#623](https://github.com/peterpeterparker/highlight-code/issues/623))
...
- as of now, code will be per default displayed in a stylish card. you could opt out setting the property `carbon` to `false` ([#525](https://github.com/peterpeterparker/highlight-code/issues/525))
...
- wrong code highlight when line numbers are off ([#423](https://github.com/peterpeterparker/highlight-code/issues/423))
...
- display optional line numbers [#115](https://github.com/peterpeterparker/highlight-code/issues/115)
...
- style: add a variable for the display of the shadowed code element ([e00a3ea](https://github.com/peterpeterparker/highlight-code/commit/e00a3ea170330de867cfedcdd0390c56988ae2f7))

# [1.0.0-alpha.11](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.10...v1.0.0-alpha.11) (2019-02-11)

### Breaking changes

- refactor CSS4 margin variable to give access to the all margin element not just margin-bottom ((ec4d260)[https://github.com/peterpeterparker/highlight-code-highlight-code/commit/ec4d2602d3fa10e8e1ddf0ee20790d1fd6646720])

# [1.0.0-alpha.10](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.9...v1.0.0-alpha.10) (2019-02-01)

### Features

- add a method to load or reload the component ([ab11a8c](https://github.com/peterpeterparker/highlight-code-highlight-code/commit/ab11a8c3be46bb7b6f3cdee6d9c7b0119baea595))
- loading of component with src and particular language ([ed88c8e](https://github.com/peterpeterparker/highlight-code-highlight-code/commit/ed88c8e92aceebeb7d673819a8bed616d8ed8022))
- prevent error in case language is set as empty ([3790fc9](https://github.com/peterpeterparker/highlight-code-highlight-code/commit/3790fc94da019047df7792628478f7a7d0c390d5))

# [1.0.0-alpha.9](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.8...v1.0.0-alpha.9) (2019-02-01)

### Fix and rollback

- if not shadowed the component was not compatible if used in other shadowed components, therefore rollback to a shadowed component ([#5](https://github.com/peterpeterparker/highlight-code-highlight-code/issues/5))

### Features

- add height new CSS4 variables to style the highlighted code ([#5](https://github.com/peterpeterparker/highlight-code-highlight-code/issues/5))

# [1.0.0-alpha.8](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.8...v1.0.0-alpha.8) (2019-02-01)

### Fix

- when the component was used in shadowed component, sometimes the slot content was not loaded ([6df0d0e](https://github.com/peterpeterparker/highlight-code-highlight-code/commit/6df0d0e6802afeba2277caa90b1b0e4ddcc39fed))

# [1.0.0-alpha.7](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.6...v1.0.0-alpha.7) (2019-02-01)

### Features

- this Web Component isn't shadowed anymore to give you full access to its style ([#5](https://github.com/peterpeterparker/highlight-code-highlight-code/issues/5))

### Fix

- synchronize load languages across multiple components ([44fac83](https://github.com/peterpeterparker/highlight-code-highlight-code/commit/44fac8378d6ea0d88ccb67175e3dcca2f0b9bb52))

# [1.0.0-alpha.6](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.5...v1.0.0-alpha.6) (2019-01-31)

### Refactor

- export anchor interface declaration ([680a2d3](https://github.com/peterpeterparker/highlight-code-highlight-code/commit/680a2d30746a9cb86c617433b46ccb5c30894491))

# [1.0.0-alpha.5](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.4...v1.0.0-alpha.5) (2019-01-23)

### Bugs

- highlight code lines: first element might be a text ([#4](https://github.com/peterpeterparker/highlight-code-highlight-code/issues/4))

# [1.0.0-alpha.4](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.3...v1.0.0-alpha.4) (2019-01-23)

### Bugs

- slot code: unescape characters ([#2](https://github.com/peterpeterparker/highlight-code-highlight-code/issues/2))
- CSS text-align per default left ([#3](https://github.com/peterpeterparker/highlight-code-highlight-code/issues/3))

# [1.0.0-alpha.3](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.2...v1.0.0-alpha.3) (2019-01-20)

### Features

- highlight code lines ([#1](https://github.com/peterpeterparker/highlight-code-highlight-code/issues/1))

# [1.0.0-alpha.2](https://github.com/peterpeterparker/highlight-code-highlight-code/compare/v1.0.0-alpha.1...v1.0.0-alpha.2) (2019-01-20)
